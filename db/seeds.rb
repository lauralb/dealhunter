...
Question.create!(:question => "¿En qué barrio se encuentra el monumento argentino conocido como 'El obelisco'?",
...
Question.create!(:question => "¿En qué año fue inaugurado el Teatro Colón?", :correct_answer => "1908", :answer1 => "1892",
...
Question.create!(:question => "Según el censo internacional realizado por la ONU, ¿en qué año la población de las ciudades superó en número a la del campo?",
...
Question.create!(:question => "¿Qué famoso guitarrista utiliza una guitarra hecha por él mismo y su padre, cuando tenía sólo 15 años?",
